...
interface CreatePostAIAssistantProps {
...
const contentSuggestions = [
  ...
  "Include more visual elements to engage readers"
];

export default function CreatePostAIAssistant({
  position,
  isFullscreen,
  onClose,
  onDragStart,
